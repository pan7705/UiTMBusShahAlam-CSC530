...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <a href="feedbackform.php" class="nav-item nav-link">Feedback</a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <img src="img/logoUiTM.png">
            <h1 class="text-white display-3 mb-5">UiTM BUS Shah Alam</h1>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    <img class="img-fluid w-100" src="img/basUitm.jpg" alt="">
                    <div class="bg-primary text-dark text-center p-4">
                        <h3 class="m-0">25+ Tahun Pengalaman</h3>
                    </div>
                </div>
                <div class="col-lg-7">
                    <h6 class="text-primary text-uppercase font-weight-bold">About Us</h6>
                    <h1 class="mb-4">Operasi Bas di UiTM Kampus Shah Alam </h1>
                    <p class="mb-4">Lebih dari 20+ bas sedia berkhidmat untuk pelajar bagi memudahkan pergerakan pelajar dari satu ke satu tempat.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-6 mb-4">
                <h3 class="text-primary mb-4">Quick Links</h3>
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white" href="feedbackform.php"><i class="fa fa-angle-right mr-2"></i>Feedback</a>
                    </div>
            </div>
        </div>
    </div>
